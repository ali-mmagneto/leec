...
PRE_LOG = os.environ.get("PRE_LOG", "-1001770934382")
...
MAX_TG_SPLIT_FILE_SIZE = int(os.environ.get("MAX_TG_SPLIT_FILE_SIZE", "4000000000"))
...
userbot = Client("UserBot", session_string=STRING_SESSION, api_id=APP_ID, api_hash=API_HASH)
